      ...
      <div className="relative z-10 w-full max-w-2xl px-6 pointer-events-none mt-16 md:mt-20">
        ...
        >
          ...
          >
            ...
            <button
              type="submit"
              className="bg-accent hover:brightness-110 text-white px-6 py-3 rounded-xl font-medium transition-all duration-300 flex items-center justify-center d-block mx-auto gap-2 shadow-[0_0_20px_rgba(29,172,253,0.3)] hover:shadow-[0_0_25px_rgba(29,172,253,0.5)] whitespace-nowrap"
            >
              Stay Tuned <ArrowRight size={18} />
            </button>
          </motion.form>
        </motion.div>
      </div>
